...
/// <summary>Shared colour, style constants, and table-factory helpers for the shielding report.</summary>
internal static class Styles
{
    ...
    internal static readonly Color White = Color.FromHex("#FFFFFF");
    internal static readonly Color Black = Color.FromHex("#000000");
    ...
    /// <summary>Creates a new <see cref="ReportTable"/> with the data-table style applied at construction.</summary>
    ...
    /// <summary>Creates a new <see cref="ReportTable"/> with the input-table style applied at construction.</summary>
